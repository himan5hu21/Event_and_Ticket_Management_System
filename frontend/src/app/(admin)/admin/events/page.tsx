...
export default function AdminEventsPage() {
  ...
  return (
    <RouteProtection allowedRoles={["admin"]}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12 bg-gradient-to-br from-blue-50 via-white to-blue-50">
        {/* 🌟 Header */}
        <div className="bg-gradient-to-r from-indigo-500 to-blue-500 rounded-3xl p-8 shadow-xl flex flex-col md:flex-row justify-between items-center">
          <div>
            <h1 className="text-4xl font-extrabold text-white mb-1">Event Management</h1>
            <p className="text-indigo-100">Search, filter, and manage all events</p>
          </div>
          <Button
            className="mt-4 md:mt-0 bg-white text-blue-600 hover:bg-blue-50 shadow-md font-medium"
          >
                ...
                >
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-4 right-4">
                      <div
                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium shadow-sm ${getStatusBadgeVariant(event.status).bg} ${getStatusBadgeVariant(event.status).text} ${getStatusBadgeVariant(event.status).border} border`}
                      >
